...
#SBATCH --job-name=mistral_gsu_ablation          # job name
...
#SBATCH --output=/l/users/maxim.panov/storage_vashurin/log/mistral_gsu_ablation.out
...
PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python HF_HOME=/l/users/maxim.panov/cache python recalc_greedy_sem_mat.py --model mistral7b --datasets trivia mmlu coqa --in_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs --out_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs/enriched --batch_size 4 --cuda_device 0 2> /l/users/maxim.panov/storage_vashurin/log/mistral_gsu_ablation_trivia.log &
PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python HF_HOME=/l/users/maxim.panov/cache python recalc_greedy_sem_mat.py --model mistral7b --datasets gsm8k_cot --in_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs --out_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs/enriched --batch_size 4 --cuda_device 1 2> /l/users/maxim.panov/storage_vashurin/log/mistral_gsu_ablation_gsm8k_cot.log &
PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python HF_HOME=/l/users/maxim.panov/cache python recalc_greedy_sem_mat.py --model mistral7b --datasets xsum --in_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs --out_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs/enriched --batch_size 4 --cuda_device 2 2> /l/users/maxim.panov/storage_vashurin/log/mistral_gsu_ablation_xsum.log &
PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python HF_HOME=/l/users/maxim.panov/cache python recalc_greedy_sem_mat.py --model mistral7b --datasets wmt14_fren wmt19_deen --in_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs --out_dir /l/users/maxim.panov/storage_vashurin/polygraph_mans/gsu_runs/enriched --batch_size 4 --cuda_device 3 2> /l/users/maxim.panov/storage_vashurin/log/mistral_gsu_ablation_wmt.log &
