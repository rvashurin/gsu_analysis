...
def parse_args():
    ...
    #parser.add_argument('--ablation_type', default='sum_grid_search', choices=['sum_grid_search', 'sum_unsup', 'dissim', 'single_seq', 'all'])
...
def main():
    ...
    for model in models:
        base_dir = f'sample_metric_mans/best_sample_with_greedy_enriched'
        ...
        for do_sample in [True, False]:
            ...
            for ablation_type in ['sum_grid_search', 'sum_unsup', 'dissim', 'single_seq']:
                ...
                with open(f'{out_dir}/{tex_prefix}_{model}_sentsar_nmt.tex', 'w') as f:
                    f.write(table)
